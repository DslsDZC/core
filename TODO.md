...
### 内存模型方向：能力 + 格（v2 讨论中，2026-08-20 记）
- 备忘：`docs/memory-model-capability-lattice.md`（v1 2026-08-16 → v2 2026-08-20）
...
- 待办：
  - 开放问题 5 项收敛（授权集完整枚举 / share 可复制性规则 / 句柄形态 / 分数权限启用时机 / 能力进规约）
